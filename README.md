...
**DSD constraint between the Role_Tellers and Role_Washers prevents johndoe from activating both simultaneously.**
...
## Manually Test the role engineering sample
 ...
 6. Switch Roles
  * Roles that are assigned to **Super_Users**, **Role_Tellers** and **Role_Washers** may switch between Buyer and Seller functions.
...
1. Add to java policy file:
  ...
  ```
grant codeBase "file:${catalina.home}/webapps/rbac-abac-sample/-" {
